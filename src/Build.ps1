...
$solutionPath = Join-Path $scriptPath "UnityFx.DependencyInjection.sln"
...
$filesToPublish = (Join-Path $scriptPath (Join-Path "UnityFx.DependencyInjection\bin" (Join-Path $configuration "\*")))
